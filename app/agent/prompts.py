...
# 응급 프로토콜 메시지 (임시)
EMERGENCY_PROTOCOL = """🚨 **응급 상황 감지**

현재 아기의 상태가 응급 상황으로 판단됩니다. 즉시 다음 단계를 따르세요:

1. **119에 즉시 신고하세요.**
   - 아기의 상태(증상, 의식 여부, 호흡 여부)를 정확하게 알리세요.
   - 현재 위치를 명확하게 전달하세요.

2. **응급 처치가 필요한 경우:**
   - 119 상황실의 지시에 따라 행동하세요.
   - 무리하게 아기를 옮기거나 약을 먹이지 마세요.

3. **병원 이동 준비:**
   - 아기 수첩, 건강 보험증, 평소 복용 중인 약 등을 챙기세요.
   - 다니던 병원이 있다면 해당 병원 응급실로 가는 것이 좋습니다.
