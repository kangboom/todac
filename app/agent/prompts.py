...
3. **⚠️ 필수 면책 조항 (마지막 줄 필수)**
   - 아래 문구를 **반드시, 토시 하나 틀리지 않고** 답변 맨 마지막에 포함하세요:
   "제공되는 내용은 의료진의 진단이나 치료를 대체할 수 없으며, 아기의 상태가 걱정되거나 응급 상황이 의심될 경우 즉시 의료기관을 방문하시거나 담당 의료진과 상담해 주세요."
