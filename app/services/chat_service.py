...
class ChatService:
    ...
    def _prepare_baby_info(baby: BabyProfile) -> Dict[str, Any]:
        ...
        age_info = ChatService._calculate_corrected_age(baby.birth_date, baby.due_date)
    ...
    def send_message(
        ...
        Returns:
            응답 정보 (response, session_id, is_emergency 등)
        """
        ...
        try:
            ...
            # 3. 대화 이력 가져오기
            conversation_history = ChatService._get_conversation_history(
                db, session.id
            )
            ...
            initial_state: AgentState = {
                ...
                "baby_info": ChatService._prepare_baby_info(baby),
                "retrieved_docs": [],
